...
import { LayoutDashboard, AlertOctagon, FileSpreadsheet, ClipboardList, ShieldCheck, BarChart3, Menu, FileText, PieChart, FolderOpen, X } from 'lucide-react';
      ...
      <div className="flex h-screen bg-slate-100 overflow-hidden">
        ...
        >
          ...
          <div className="p-4 border-t border-police-800">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-police-700 flex items-center justify-center">AD</div>
              <div>
                <p className="text-sm font-medium">Admin User</p>
                <p className="text-xs text-police-400">Đang trực tuyến</p>
              </div>
            </div>
          </div>
        </aside>
        ...
        <main className="flex-1 overflow-auto relative flex flex-col w-full">
          ...
          <header className="bg-police-900 text-white shadow-sm p-4 flex items-center justify-between md:hidden sticky top-0 z-20">
             ...
             <div className="flex gap-4">
                ...
                <Link to="/results"><PieChart className="w-6 h-6 text-slate-300 hover:text-white" /></Link>
             </div>
          </header>
